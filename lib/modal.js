...
const _addAllEvents = (el, fn, query, names) => names.map(addEvent(el, fn, query));
...
export const open = (inner, options = {}) => {
    ...
    addAllEvents('main', onMainClick(onOverlayClick), query, ['mousedown', 'contextmenu']);
